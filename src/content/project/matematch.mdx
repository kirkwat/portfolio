...
image: "./images/matematch/thumbnail.jpg"
logo: "./images/matematch/logo.png"
themeColor: "#84cc16"
featured: 2
technologies:
  - name: JavaScript
...
import Logo from "./images/matematch/logo.png";

<a href="https://matematching.com/" target="\_blank" rel="noopener noreferrer">
  <Image src={Logo} alt="MateMatch Logo" width="400" class="no-shadow" />
</a>
