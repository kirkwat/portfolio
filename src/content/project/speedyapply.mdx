...
image: "./images/speedyapply/thumbnail.png"
logo: "./images/speedyapply/logo.png"
themeColor: "#6366f1"
featured: 1
technologies:
  - name: TypeScript
...
import Logo from "./images/speedyapply/logo.png";

<a href="https://speedyapply.com/" target="\_blank" rel="noopener noreferrer">
  <Image src={Logo} alt="SpeedyApply Logo" width="400" class="no-shadow" />
</a>
